...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.crashed) return (
      <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'#0B1226', color:'#fff', padding:'24px', textAlign:'center' }}>
        ...
        <button onClick={() => window.location.reload()} style={{ background:'#2F6FED', color:'#fff', border:'none', borderRadius:'12px', padding:'12px 28px', fontSize:'16px', cursor:'pointer' }}>
          Перезагрузить
        </button>
